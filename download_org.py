...
from weedremeed_client.api.projects import get_project, list_projects
from weedremeed_client.models.project import Project

parser = ArgumentParser(
    description="Utility for downloading organisations from Weedremeed",
...
for project in projects:
    project = get_project.sync(client=client, project_id=project.id)
